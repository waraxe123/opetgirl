...
from CatXRobot.Cache.checker import checkerCB
from CatXRobotc.Cache.admins import AdminRightsCheck
...
from CatXRobot import BOT_USERNAME, BOT_NAME, app, db_mem
from CatXRobot.Helpers.Inline import (audio_markup, primary_markup, close_key)
from CatXRobot.Helpers.Database import (add_active_chat, is_active_chat, remove_active_chat, is_music_playing, music_off, music_on)
...
async def admin_risghts(_, CallbackQuery):
    ...
    if command == "pausecb":
        ...
        await CatXRobot.pytgcalls.pause_stream(chat_id)
    ...
    if command == "skipcb":
        ...
        if Queues.is_empty(chat_id):
            ...
            await CatXRobot.pytgcalls.leave_group_call(chat_id)
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = "CatXRobot/Utilities/Audio.jpeg"
                    aud = 1
                else:
                    _path_ = _path_ = (
                        (str(afk))
                    ...
                    thumb = f"CatXRobot/Cache/{_path_}final.png"
                    buttons = primary_markup(
                        videoid,
                        CallbackQuery.from_user.id,
                    )
