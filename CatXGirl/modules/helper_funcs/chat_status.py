...
def is_user_admin(chat: Chat, user_id: int, member: ChatMember = None) -> bool:
    if (
        ...
        or user_id in [777000, 5171347305]
...
def whitelist_plus(func):
    ...
    def is_whitelist_plus_func(
        ...
        if user and is_whitelist_plus(chat, user.id):
            ...
            update.effective_message.reply_text(
                f"You don't have access to use this.\nVisit @{SUPPORT_CHAT}  Join My Creator Support Channel [CatXGirl News](t.me/CatXGirlNews)"
            )
...
def user_can_ban(func):
    ...
    def user_is_banhammer(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if (
            ...
            and user not in [777000, 5171347305]
        ):
    ...
    def connected_status(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if conn:
            ...
            if update.effective_message.chat.type == "private":
                update.effective_message.reply_text(
                    "Send /connect in a group that you and I have in common first. Second Join My Group And Channels [CatxGirl News](t.me/CatXGirlNews) | [CatXGirl Support](t.me/CatxGirlSupport)"
                )
