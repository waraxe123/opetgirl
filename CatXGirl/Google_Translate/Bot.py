...
@app.on_message(filters.private & filters.command(['trstart']))
async def start(client, message):
	await message.reply_text(text =f"Hello **{message.from_user.first_name }** \n\n Wellcome CatXGirl  Translate Menu \n I can translate any language to you selected language..",reply_to_message_id = message.message_id ,parse_mode="markdown", reply_markup=InlineKeyboardMarkup([ [                    InlineKeyboardButton("Updates 🇱🇰" ,url="https://t.me/CatXGirlNews") ],               [InlineKeyboardButton("Support 🇱🇰", url="https://t.me/CaxGirlSupport") ]   ]  ) )
