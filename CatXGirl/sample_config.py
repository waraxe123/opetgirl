...
class Config(object):
    ...
    OWNER_USERNAME = "broken or stupid"
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgresql://uranhezt:wNvf2yWqH23GlkPAlzEMkavHdg954DnI@arjuna.db.elephantsql.com:5432/uranhezt"  # needed for any database modules
    LOAD = []
    NO_LOAD = ["rss", "cleaner", "connection", "math"]
    WEBHOOK = False
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "5K2DHwcQV9aWSH3ApA~Ywm4jk1wDZF7YME~p~twPxXkiK8ASe2ypp8UH9g8egsoh"  # go to support.spamwat.ch to get key
